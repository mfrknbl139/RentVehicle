...
namespace RentVehicle.Classes
{
    ...
    public class Vehicle
    {
        ...
        // Constructor
        public Vehicle(string user, string model, int year, decimal rentalPricePerDay, VehicleType type)
        {
        ...
        {
            Console.WriteLine($"ID: {Id}, UserName: {UserName}, Model: {Model}, Year: {Year}, Rental Price/Day: {RentalPricePerDay:C}, Available: {(IsAvailable ? "Yes" : "No")}");
        }
